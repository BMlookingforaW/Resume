...
const Data = () => {
    return (
        <div className='home__data'>
            <h1 className='home__title'>Bharat Mishra
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <p className='home__description'>I am a pre-final student at Delhi Technological University, and I'm a passinate to learn. 
            </p>
